...
func TestVaultServiceIntegration(t *testing.T) {
	...
	testVaultDir := setupIntegrationTestVault(t)
...
// setupIntegrationTestVault creates a test vault with sample markdown files
func setupIntegrationTestVault(t testing.TB) string {
	t.Helper()
